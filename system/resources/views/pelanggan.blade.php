    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><i class="fa fa-comments"></i> <strong>Olshop Kampus </strong></a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="admin"><i class="fa fa-dashboard"></i> Beranda</a>
                    </li>
                    <li>
                        <a href="produk-admin"><i class="fa fa-desktop"></i> Produk</a>
                    </li>
                    <li>
                        <a href="chart"><i class="fa fa-bar-chart-o"></i> Promo</a>
                    </li>
                    <li>
                        <a href="kategori"><i class="fa fa-qrcode"></i> Kategori</a>
                    </li>
...
<!--                     <li>
                    ...
                    <li>
                        <a class="active-menu" href="master-data"><i class="fa fa-sitemap"></i> Master Data<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu" href="pelanggan">Pelanggan</a>
                            </li>
                            <li>
             ...
             <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Pelanggan <small>This is your Pelanggan section</small>
                        </h1>
                    </div>
                </div>
            </div>
