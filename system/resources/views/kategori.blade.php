        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="promo"><i class="fa fa-bar-chart-o"></i> Promo</a>
                    </li>
                    <li>
                        <a class="active-menu" href="kategori"><i class="fa fa-qrcode"></i> Kategori</a>
                    </li>
...
<!--                     <li>
                    ...
                    <li>
                        <a href="master-data"><i class="fa fa-sitemap"></i> Master Data<span class="fa arrow"></span></a>
             ...
             <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Kategori <small>This is your Kategori section</small>
                        </h1>
                    </div>
                </div>
            </div>
